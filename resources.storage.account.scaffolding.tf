...
# and set the argument to `create_storage_resource_group = false`. Location will be same as existing RG.
#---------------------------------------------------------
# Resource Group Creation
#----------------------------------------------------------
data "azurerm_resource_group" "rgrp" {
  count = var.create_storage_resource_group == false ? 1 : 0
...
module "mod_storage_rg" {
  ...
  count = var.create_storage_resource_group ? 1 : 0
